...
@interface Level1GameObjects (PrivateMethods)
...
@implementation Level1GameObjects
...
- (void) instantiateGameObjects
{
    ...
    //pipe
    self.pipe1 = [[(Pipe *)[Pipe alloc] initWithPos:ccp(screenSize.width*0.13, screenSize.height*0.683) shape:PIPE1 AndWorld:world] autorelease];    
    [self addChild:pipe1.sprite z:PIPETAG tag:PIPETAG];        
    self.pipe3 = [[(Pipe *)[Pipe alloc] initWithPos:ccp(screenSize.width*0.45, screenSize.height*0.47) shape:PIPE3 AndWorld:world] autorelease];    
    [self addChild:pipe3.sprite z:PIPETAG tag:PIPETAG];
    
    //cradle
    self.cradle = [[(Cradle *)[Cradle alloc] initWithPos:ccp(screenSize.width*0.7, screenSize.height*0.08) AndWorld:world] autorelease];
    ...
    //carrot
    self.carrot = [[(Carrot *)[Carrot alloc] initWithPos1:ccp(screenSize.width*0.2083, screenSize.height*0.5371) Pos2:ccp(screenSize.width*0.62, screenSize.height*0.42) Pos3:ccp(screenSize.width*0.7, screenSize.height*0.22)] autorelease];
