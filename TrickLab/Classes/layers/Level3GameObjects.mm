...
@interface Level3GameObjects (PrivateMethods)
...
@implementation Level3GameObjects
...
{
    //baby hamster
    self.babyHamster = [[(BabyHamster *)[BabyHamster alloc] initWithPos:ccp(screenSize.width*0.65, screenSize.height*0.81) level:levelSelected AndWorld:world] autorelease];
    ...
    //mother hamster
    self.motherHamster = [[(MotherHamster *)[MotherHamster alloc] initWithPos:ccp(screenSize.width*0.33, screenSize.height*0.13)] autorelease];
    [self addChild:motherHamster.sprite z:MOTHERHAMSTERTAG tag:MOTHERHAMSTERTAG];
    
    //cage
    self.cage = [[(Cage *)[Cage alloc] initWithPos:ccp(screenSize.width*0.65, screenSize.height*0.83) AndWorld:world] autorelease];
    [self addChild:cage.sprite z:CAGEFRONTTAG tag:CAGEFRONTTAG];
    [self addChild:cage.spriteBack z:CAGEBACKTAG tag:CAGEBACKTAG];  
    
    //floater
    self.floater = [[(Floater *)[Floater alloc] initWithPos:ccp(screenSize.width*0.5, screenSize.height*0.4) move:RIGHT AndWorld:world] autorelease];
    [self addChild:floater.sprite z:FLOATERTAG tag:FLOATERTAG]; 
    
    //blower1
    self.blower1 = [[(Blower *)[Blower alloc] initWithPos:ccp(screenSize.width*0.9, screenSize.height*0.6) Angular:180 Range:screenSize.width*0.52] autorelease];
    blower1.sprite.scaleY = -1;
    [self addChild:blower1.sprite z:BLOWERTAG tag:BLOWERTAG];
    
    //blower2
    self.blower2 = [[(Blower *)[Blower alloc] initWithPos:ccp(screenSize.width*0.9, screenSize.height*0.3) Angular:180 Range:screenSize.width*0.4] autorelease];
    blower2.sprite.scaleY = -1;
    [self addChild:blower2.sprite z:BLOWERTAG tag:BLOWERTAG];
    
    //pipe
    self.pipe4 = [[(Pipe *)[Pipe alloc] initWithPos:ccp(screenSize.width*0.4, screenSize.height*0.6) shape:PIPE4 AndWorld:world] autorelease];    
    [self addChild:pipe4.sprite z:PIPETAG tag:PIPETAG];        
    
    //cradle
    self.cradle = [[(Cradle *)[Cradle alloc] initWithPos:ccp(screenSize.width*0.16, screenSize.height*0.08) AndWorld:world] autorelease];
    ...
    //carrot
    self.carrot = [[(Carrot *)[Carrot alloc] initWithPos1:ccp(screenSize.width*0.239, screenSize.height*0.56) Pos2:ccp(screenSize.width*0.65, screenSize.height*0.6) Pos3:ccp(screenSize.width*0.55, screenSize.height*0.24)] autorelease];
...
{    
    ...
    if (floater.startContactWithBabyHamster){
        ...
        [floater autoMoveWithDistance:screenSize.width*0.3];
    }
